...
app.post('/api/tags/attach', async (req, res) => {
...
app.post('/api/tags/detach', async (req, res) => {
  const { tagId, placeId } = req.body;
  if (!tagId || !placeId) {
    return res.status(400).json({ error: 'tagId and placeId required' });
  }
...
app.get('/api/tags/for-place', async (req, res) => {
...
app.post('/api/lists/add-item', async (req, res) => {
...
app.post('/api/lists/remove-item', async (req, res) => {
  const { listId, placeId } = req.body;
  if (!listId || !placeId) {
    return res.status(400).json({ error: 'listId and placeId required' });
  }
...
app.get('/api/lists/by-share/:shareId', async (req, res) => {
